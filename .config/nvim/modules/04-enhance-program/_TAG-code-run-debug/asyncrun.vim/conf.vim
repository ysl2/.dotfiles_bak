" ===
" === AsyncRun 参考：https://github.com/zhenyangze/dotvim/blob/master/layers/common/terminal-asyncrun.vim
" ===
...
function! AsyncRunRun()
  ...
  elseif &filetype == 'python'
    ...
    execute 'AsyncRun! -mode=term -pos=bottom -rows=10 -raw python %'
  ...
  elseif &filetype == 'sh'
    execute 'AsyncRun! -mode=term -pos=bottom -rows=10 sh "$(VIM_RELNAME)"'
