...
noremap <leader><leader>1 :tabe ~/.dotfiles/nvim/.config/nvim/core/vmap.vim
noremap <leader><leader>2 :tabe ~/.dotfiles/nvim/.config/nvim/modules/
noremap <leader><leader>3 :tabe ~/.dotfiles/nvim/.config/nvim/
