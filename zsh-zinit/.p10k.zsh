...
cyan='#9AEDFE'
white='#F1F1F0'
# Generated by Powerlevel10k configuration wizard on 2021-04-19 at 16:24 CST.
# Based on romkatv/powerlevel10k/config/p10k-pure.zsh, checksum 13301.
# Wizard options: awesome-fontconfig, large icons, pure, snazzy, 24h time, 2 lines,
...
# NOTE: The config below is stolen from "https://github.com/romkatv/powerlevel10k/blob/master/config/p10k-lean.zsh"
